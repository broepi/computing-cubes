...
build/computingcubes :  build/computingcubes.o build/application.o build/error.o build/eventmanager.o build/main.o
	g++ -o build/computingcubes   build/computingcubes.o build/application.o build/error.o build/eventmanager.o build/main.o -lSDL2
